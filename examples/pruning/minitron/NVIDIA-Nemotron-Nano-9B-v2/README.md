...
Results on a single H100 (ISL=4096, OSL=2048):
...
| Checkpoint | Output tokens/s | Speedup vs Nemotron-Nano-9B-v2 BF16 |
| --- | --- | --- |
| Nemotron-Nano-12B-v2 (official) | 1,765 | 0.73× |
| Nemotron-Nano-9B-v2 (official) | 2,417 | 1.00× |
| Nemotron-Nano-9B-v2-FP8 (official) | 2,875 | 1.19× |
| Nemotron-Nano-9B-v2-Pruned-7B | 2,661 | 1.10× |
| Nemotron-Nano-9B-v2-Pruned-7B-FP8 | 3,242 | 1.34× |

In this case, FP8 delivers a ~20% throughput gain over BF16 at the same parameter count. The NemotronH hybrid architecture (Mamba + attention) moderates this gain relative to pure-transformer models, since Attention and Conv1d layers are not quantized.
