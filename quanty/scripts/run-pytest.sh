...
TESTS=(
    tests/unit/torch/quantization/plugins/test_huggingface.py::test_get_homogeneous_hf_decoder_layers_vlm_language_model
    tests/unit/torch/quantization/plugins/test_huggingface.py::test_get_homogeneous_hf_decoder_layers_vlm_text_model
...
exec python -m pytest -x -v --no-header "${TESTS[@]}" "$@"
